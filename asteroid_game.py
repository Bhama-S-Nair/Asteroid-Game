...
def main():
    ...
    level = 1
    level_display_timer = 120  # frames to show level text (2 seconds)

    show_congrats = False

    # NEW: Track if new high score was achieved this run
    new_highscore_achieved = False
    highscore_music_played = False  # To avoid replaying music continuously
    ...
    while True:
            ...
            for asteroid in asteroids[:]:
                if not asteroid.broken:
                    ...
                    if asteroid.y - asteroid.radius > HEIGHT:
                        ...
                        if lives <= 0:
                            game_over = True
                            # NEW: Check for new high score when player dies
                        ...
                        game_over = True
                        # NEW: Check for new high score on collision death
                        if destroyed > high_score:
                            high_score = destroyed
                            save_high_score(high_score)
                            new_highscore_achieved = True
        ...
        # NEW: Play highscore music once if new high score achieved
        ...
        # Display current level at top middle
